...
export NIWG_DATA="/home/stowell/t2krep/NIWG/external_data/v0r1/" #path to external data    
...
# Neut
export NEUT="/home/stowell/t2krep/NIWG/neut/branches/neut_5.3.6/" #/path/to/neut

# NIWG
export NIWGREWEIGHT="/home/stowell/t2krep/GlobalAnalysisTools/NIWGReWeight/" #/path/to/niwgreweight

# T2K RW Stuff
export T2KREWEIGHT="/home/stowell/t2krep/GlobalAnalysisTools/T2KReWeight/" # path to t2krew
